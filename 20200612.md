...
- ```
      ...
      <div class="header entire setbackground" v-bind:style="{'background-image': 'linear-gradient(to right, rgba(26.27%, 9.41%, 18.43%, 1.00) 150px, rgba(34.12%, 15.69%, 25.49%, 0.84) 100%), url(' + posterURL + movie.backdrop_path + ')' }">
        <div class="inner-header p-3 d-flex float-this">
          <div class="row">
            ...
            <div class="col-8" >
              {{ movie }}
              <h3><strong>{{ movie.title }}</strong><span class="dimcolor">({{movie.release_date.slice(0, 4)}})</span></h3>
              <p><span v-for="genre in movie.genres" :key="`genre_${genre.id}`">{{ genre.name }}여기장르자리</span></p>
              <div class="clear-float">
                <div class="c100 small" :class="computedClass">
                ...
                <!-- 채워진 하트 -->
                <svg v-show="like" @click="changeLike" class="bi bi-heart-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
                </svg>
  
                <!-- 빈 하트 -->
                <svg v-show="!like" @click="changeLike" class="bi bi-heart" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M8 2.748l-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/>
                </svg>
  
                <button @click="click" class="btn button-transparent text-white" data-toggle="modal" :data-target="'#'+movie.id">► 예고편 보기 </button>
  
                <div   class="modal fade" :id="movie.id" tabindex="-1" role="dialog" aria-labelledby="trailerModalLabel" aria-hidden="true">
  ...
  //         axios.get(SERVER.URL + `/movies/${movieID}/${this.cookies.get('userId')}/like/`)
  //           .then(res => {
  //             // 결과 받은 뒤에 할 것들
  //             // {'like': False}
  //             // 하트 색깔 바꿈
          ...
          <div class="row">
            ...
            <div class="col-8" >
              ...
              <div class="clear-float">
                ...
                <span class="user_score">User<br>Score</span>
                ...
                <button class="btn button-transparent text-white" data-toggle="modal" :data-target="'#movie'+movie.movieId">► 예고편 보기 </button>
...
<span v-show="like" @click="changeLike" style="color: Tomato;"><i class="fas fa-heart fa-2x"></i></span> 

​              <span v-show="!like" @click="changeLike" style="color: black;"><i class="far fa-heart fa-2x"></i></span> 
